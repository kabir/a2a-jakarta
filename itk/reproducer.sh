...
# Set default log level to DEBUG for the reproducer
export A2A_ITK_REVISION=main
export ITK_LOG_LEVEL="${ITK_LOG_LEVEL:-DEBUG}"
...
# 1. Copy latest instruction.proto from a2a-itk
...
SCENARIO_FILE="scenarios_debug.json"
