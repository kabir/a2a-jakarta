# Contributing to A2A Jakarta

Welcome to the A2A Jakarta project! We welcome contributions from the community. This guide will walk you through the steps for getting started on our project.
...
To contribute, you will first need to fork the [a2a-jakarta](https://github.com/wildfly-extras/a2a-jakarta) repository.

This can be done by looking in the top-right corner of the repository page and clicking "Fork".

The next step is to clone your newly forked repository onto your local workspace. This can be done by going to your newly forked repository, which should be at `https://github.com/USERNAME/a2a-jakarta`.
...
The A2A Jakarta project uses GitHub Issues to manage issues. All issues can be found [here](https://github.com/wildfly-extras/a2a-jakarta/issues).
...
Want to contribute to A2A Jakarta but aren't quite sure where to start? Look for issues with the `good first issue` label. These are a triaged set of issues that are great for getting started on our project. These can be found [here](https://github.com/wildfly-extras/a2a-jakarta/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22).
...
First `cd` to the directory where you cloned the project (e.g., `cd a2a-jakarta`)

Add a remote ref to upstream, for pulling future updates.
For example:

```bash
git remote add upstream https://github.com/wildfly-extras/a2a-jakarta
```
...
* GitHub Issues - https://github.com/wildfly-extras/a2a-jakarta/issues
